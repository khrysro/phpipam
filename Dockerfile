...
RUN apt-get update && \
	apt-get install -y git php-pear php5-curl php5-cli libapache2-mod-php5 php5-gd php5-mysql php5-json php5-gmp php5-mcrypt php5-ldap libgmp-dev libmcrypt-dev && \
