...
RUN apt-get update && \
	apt-get install -y php5-snmp php-pear php5-curl php5-gd php5-mysql php5-json && apt-get install -y php5-gmp php5-mcrypt php5-ldap libpng-dev libgmp-dev libmcrypt-dev && \
